...
namespace bcs.arcSpace.Data_Layer
{
   public class IssuingAuthorityReign_DL
   {
      ...
      public class IssuingAuthorityReign_DL
      {
         public static bool InsertIssuingAuthorityReignRecord(Authority objAuthority)
         {
         ...
         public static bool UpdateIssuingAuthorityReignRecord(Authority objAuthority)
         {
         ...
         public static bool DeleteIssuingAuthorityReignRecord(Authority objAuthority)
         {
         ...
         public static List<Authority> GetIssuingAuthorityReignRecordList()
         {
         ...
         public static List<Authority> GetIssuingAuthorityReignRecord(int authorityId)
         {
            Authority objAuthority;
         ...
         public static List<Authority> GetIssuingAuthorityReignRecordGivenPeriodId(int periodId)
         {
            Authority objAuthority;
            List<Authority> lstAuthority = null;
